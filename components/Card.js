...
export default function Card({ title, subtitle, summary, children }) {
  ...
  return (
    <div
      className={
        "terminal:rounded-none terminal:border-[1px] terminal:border-orange-500 terminal:bg-gray-950 flex cursor-pointer break-inside-avoid flex-col rounded-lg border-2 bg-slate-50 p-3 transition [-webkit-tap-highlight-color:transparent] dark:border-slate-800/75	dark:bg-slate-800/75 dark:hover:bg-slate-800 print:border-none print:p-0 " +
